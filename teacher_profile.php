...
<div class="form-a teacher_account"   id="md" >
  ...
  <?php
    ...
    if (isset($_POST['cp'])) {
        ...
        if ($con) {
          ...
          $intitute=ucwords($ins);
          $ccc =$_POST['countryname'];
          $country=ucwords($ccc);
          $c_city =$_POST['city'];
          $city=ucwords($c_city);
          $email =$_POST['email'];
          ...
          $check = mysqli_num_rows($result);
                ...
                <style>
                  .form-a2{display: none;}
                  #md{height: 500px}
                  @media (min-width: 960px) {    #md{  transform: translate(0%,-100%); height: 500px}   }
                  @media (min-width:576px) and (max-width: 959px) {    #md{  transform: translate(0%,-93%); }  }
                  @media (min-width:405px) and (max-width: 575px) {    #md{  transform: translate(0%,-70%); } #create_profile_btn{ width: 35% }  }
                  @media (min-width: 325px) and (max-width: 405px) {    #md{  transform: translate(0%,-70%); } #create_profile_btn{ width: 45% }  }
                  @media (min-width: 258px) and (max-width: 325px) {    #md{  transform: translate(0%,-70%); }  #create_profile_btn{ width: 55% }  }
                  @media (max-width: 258px) {    #md{  transform: translate(0%,-70%); } #create_profile_btn{ width: 100%}  }
                 .alert {
                   margin-top: 30px;
                 	width: 50%;
                 	margin: 0 auto;
  ...
  ?>
    ...
    <form class="form-a2" action="" method="post" onsubmit="return fn()">
              ...
              <div class="text-center ">
                ...
                <div class="row "  style="margin-left: 10%" >
                  <div class="col-sm  pb-3 ">
                    <div class="">
                      ...
                      <input type="text" id="tname" name="tname" placeholder="Enter Teacher Name:" class="form-control py-4 w-75 text  font-weight-bold" autocomplete="off" required pattern="^[a-zA-Z][a-zA-Z0-9-_\s.]{1,40}$" title="Name must be start with Alphabit " minlength="3" maxlength="40">
                      <span id="sttd" class="font-weight-bold" style="color:greenyellow"></span>
                    </div>
                  </div>
                  <div class="col-sm  pb-3">
                    <label id="input_labal"><b>Contact NO:</b></label>
                    <input type="text" id="thr" name="contact" placeholder="Enter contact no" class="form-control py-4 w-75 text font-weight-bold" autocomplete="off" required pattern="\d+" title="Please enter valid contact number" minlength="7" maxlength="20">
                    <span id="sttd" class="font-weight-bold" style="color:greenyellow"></span>
                  </div>
                </div>
                ...
                <div class="row"  style="margin-left: 10%" >
                  <div class="col-sm  pb-3">
                    ...
                    <input type="text" id="tname" name="cnic" placeholder="Enter Cnic no " class="form-control py-4 w-75 text  font-weight-bold" autocomplete="off" required pattern="\d+" title="Please enter valid cnin no " minlength="13" maxlength="15">
                    <span id="fnme" class="font-weight-bold" style="color:greenyellow" ></span>
                  </div>
                  <div class="col-sm  pb-3">
                    <label id="input_labal"><b>Institute Name:</b></label>
                    <input type="text" id="lname" name="institutename" placeholder="Enter educational Institute name" class="form-control py-4 w-75 text font-weight-bold" autocomplete="off" required pattern="^[a-zA-Z][a-zA-Z0-9-_\s.]{3,80}$" title="must be greater then 3 charseter.">
                ...
                <div class="row mt-4 " style="margin-left: 10%">
                  <div class="col-sm pb-3">
                    ...
                    <input type="text" id="lname" name="countryname" placeholder="Enter Country name" class="form-control py-4 w-75 text font-weight-bold" autocomplete="off" required pattern="^[a-zA-Z][a-zA-Z0-9-_\s.]{3,40}$" title="country name must be start from Alphabit">
                    <span id="lnme" class="font-weight-bold" style="color:greenyellow"></span>
                  </div>
                  <div class="col-sm ">
                    <label id="input_labal"><b>City Name:</b></label>
                    <input type="text" id="lname" name="city" placeholder="Enter educational city name" class="form-control py-4 w-75 text  font-weight-bold" autocomplete="off" required pattern="^[a-zA-Z][a-zA-Z0-9-_\s.]{2,30}$">
                    <span id="lnme" class="font-weight-bold" style="color:greenyellow"></span>
                  </div>
                </div>
                <!-- ended -->
                <div class="row mt-4"  style="margin-left: 10%">
                  <div class="col-sm pb-3 ">
                    ...
                    <input type="email"   placeholder="Email" class="form-control py-4 w-75 text font-weight-bold" autocomplete="off" required  id="e1">
                    <span id="Email" class="font-weight-bold" style="color:greenyellow"></span>
                  </div>
                  <div class="col-sm ">
                    <label id="input_labal"><b>Confirm Email :</b></label>
                    <input type="text" name="email" placeholder="Confirm Email" name="cem" class="form-control py-4 w-75 text  font-weight-bold" autocomplete="off" required id="e2">
                ...
                <div class="row mt-4 pb-1" style="margin-left: 10%">
                  <div class="col-sm pb-3">
                    ...
                    <input type="password"  placeholder="Password" class="form-control py-4 w-75 text font-weight-bold" autocomplete="off" required minlength="8"  id="p1">
                    <span id="paswd" class="font-weight-bold" style="color:greenyellow"></span>
                  </div>
                  <div class="col-sm ">
                    <label id="input_labal"><b>Confirm Password :</b></label>
                    <input type="password" name="pass"  placeholder="Confirm Password" class="form-control py-4 w-75 text font-weight-bold" autocomplete="off" required minlength="8"  id="p2" >
...
<!--=========================================== Security question ==========================================================================================================================================-->
                <div class="row mt-4 pb-3" style="margin-left: 10%">
                  <div class="col-sm form-group pb-3 ">
                    <label  for="sel1"><b>Select  Security  Qustion </b></label>
                  ...
                  <div class="col-sm ">
                    ...
                    <input type="text" name="q_answer"  placeholder="Enter the Answer of Your Security Question" class="form-control py-4 w-75 text font-weight-bold" autocomplete="off"  maxlength="30" required>
                  </div>
                </div>
  <!--=========================================== Security question ended ==========================================================================================================================================-->
                ...
                <div class="col-lg pb-5" style="margin-left: 10%">
                  <input type="submit"  value="Create Profile" class="btn btn-lg py-3 font-weight-bold" id="create_profile_btn" name="cp"  onclick="return fn();">
