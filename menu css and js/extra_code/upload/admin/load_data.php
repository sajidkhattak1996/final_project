...
while ($details = mysql_fetch_array($result_pag_data)) {	
    $msg .= "<tbody>
				 ...
				 <td align='left'>				    
				    ...
				    <td align='left'>
						<a href='".$details['floc']."' alt='Download' title='Download' class='btn btn-primary' target='_blank' >
						<span class='glyphicon glyphicon-download-alt'>Download</span></a><br /><br />
						
						<input type='checkbox' value='".$details['id']."' name='id'>Check this for detele</checkbox>
