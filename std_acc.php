              ...
              <div class="text-center ">
                ...
                <div class="row">
                  <div class="col-sm  pb-3">
                    ...
                    <input type="text" id="std" name="class_id" value="<?php if(isset($_POST['btn_sp'])){ echo $_POST['class_id']; }; ?>"  placeholder="Enter Class ID" class="form-control py-4 w-75 text" autocomplete="off" required pattern="\d+" title="Please enter only pasitive numbers" minlength="1">
                    <span id="sttd" class="font-weight-bold " style="color: greenyellow"></span>
                  </div>
                  <div class="col-sm  pb-3">
                    <label id="input_labal"><b>Enrollment Key </b></label>
                    <input type="text" id="enroll" name="enroll_key" value="<?php if(isset($_POST['btn_sp'])){ echo $_POST['enroll_key']; }; ?>"  placeholder="Enter Enrollment Key" class="form-control py-4 w-75 text" autocomplete="off" required minlength="2" title="Enter Enrollment key which given to you by your teacher">
                    <span id="enr" class="font-weight-bold" style="color:greenyellow"></span>
                  </div>
                  <div class="col-sm">
                    <label id="input_labal"><b>Class NO </b></label>
                    <input type="text" id="std" name="class_no" value="<?php if(isset($_POST['btn_sp'])){ echo $_POST['class_no']; }; ?>"  placeholder="Enter Your Class No " class="form-control py-4 w-75 text" autocomplete="off" required pattern="\d+" title="Please enter only pasitive numbers" minlength="1">
                ...
                <div class="row mt-4">
                  <div class="col-sm pb-3">
                    ...
                    <input type="email" name="email1" value="<?php if(isset($_POST['btn_sp'])){ echo $_POST['email1']; }; ?>" placeholder="Email" class="form-control py-4 w-75 text" autocomplete="off" required  id="e1">
                    <span id="Email" class="font-weight-bold" style="color:greenyellow"></span>
                  </div>
                  <div class="col-sm ">
                    <label id="input_labal"><b>Confirm Email :</b></label>
                    <input type="text" name="email2" value="<?php if(isset($_POST['btn_sp'])){ echo $_POST['email2']; }; ?>" placeholder="Confirm Email" class="form-control py-4 w-75 text" autocomplete="off" required id="e2">
                ...
                <div class="row mt-4 pb-3">
                  <div class="col-sm pb-3">
                    ...
                    <input type="password" name="password1" value="<?php if(isset($_POST['btn_sp'])){ echo $_POST['password1']; }; ?>" placeholder="Password" class="form-control py-4 w-75 text" autocomplete="off" required minlength="8"  id="p1" title="At least Eight character are required!.">
                    <span id="paswd" class="font-weight-bold" style="color:greenyellow"></span>
                  </div>
                  <div class="col-sm ">
                    <label id="input_labal"><b>Confirm Password </b></label>
                    <input type="password"  name="password2" value="<?php if(isset($_POST['btn_sp'])){ echo $_POST['password2']; }; ?>" placeholder="Confirm Password" class="form-control py-4 w-75 text" autocomplete="off" required minlength="8"  id="p2" >
