...
<?php
  ...
  $sn="SELECT student_name FROM student WHERE S_id='$std_id'";
              ...
              <?php
                  if (isset($con)) {
                    ...
                    //the below query extract all the student sttndence records of that class and subject
                        $stmt1="SELECT attendence_record.S_id,attendence_record.AT_date,attendence.status FROM attendence INNER JOIN attendence_record ON attendence.AT_id=attendence_record.AT_id WHERE attendence_record.Class_id='$cid' AND attendence_record.Subject_id='$subid' AND attendence_record.S_id='$S_id' ORDER BY attendence_record.AT_date DESC";
