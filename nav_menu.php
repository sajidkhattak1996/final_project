...
<!--					<a href="#" style="margin-top: -60px;">Forgot password</a>-->
            ...
            <div id="FPdiv" style="border-radius: 0px 0px 20px 20px;display:none;">
                  <h5 id="FPmsg">Forgot Password:<a href="forgot_password.php" >Click here</a></h5>
            </div>
				</form>
			</div>
		</li>
  ...
  //hide the open div Classes
  // function Myfn_hide(){
  //   // var about=document.getElementById('md');
                ...
                /* this condition check and use if email are found in the  both table and also there Password are also same for them */
                    ...
                    if ($t1==1 AND $t2==0 ) {
                      ...
                      <script type="text/javascript">
                          window.location.href="teacher_table/tmain_table.php?e=<?php echo $em; ?>&p=<?php echo $password; ?>";
                      </script>
