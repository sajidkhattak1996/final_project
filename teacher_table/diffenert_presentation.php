                    ...
                    <table class="table table-straped">
                          <thead>
                            <tr>
                                ...
                                <td>
                                      Date:<br>
                                      <input type="date" name="p_date" value="<?php echo date('Y-m-d'); ?>" title="Enter the pregnment Date" required style="background: lightblue;border: solid 1px #008c7e;border-radius:5px">
                                </td>
                                <form method="post">
                                  <td>
                                      Total Marks:<br> <input type="number" name="pt_marks" id="t_marks"  title="Enter pregnment Total Marks" min="1" max="5000" placeholder="marks" required style="background: lightblue;border: solid 1px #008c7e;border-radius:5px">
                                  </td>
                                </form>
                            </tr>
                                    ...
                                    while ($row=mysqli_fetch_assoc($exe)) { $a++;
                                      ...
                                      <tr id="r<?php echo $a; ?>">
                                        ...
                                        <td>
                                          ...
                                          <input type="number" name="po_marks<?php echo $a; ?>" id="ob_marks<?php echo $a; ?>" title="please Enter the Student Obtained Marks" min="0" max="5000" required style="background: lightblue;border: solid 1px #008c7e;border-radius:5px">
                                        </td>
                                      </tr>
                                    <?php }
                                    $_SESSION['a']=$a;
