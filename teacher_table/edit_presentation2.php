              ...
              <!--============ended=============================================================================================================================-->
                ...
                <div class="tend "  style="border-radius: 10px 10px 0px 0px;width:100%;margin:0 auto;margin-bottom: 8px;height: auto;padding-bottom:3px;padding-top: 0px">
                    <div class="row  py-3" style="border-bottom: solid 2px #fff">
                      ...
                      <div class="col-lg-2 col-sm-3">
                        <a href="edit_presentation1.php" class="btn btn-primary float-right" > Edit Presentation   </a>
                      </div>
                    </div>
                    <?php
                    $sid=0;
                          ...
                          if (mysqli_num_rows($ass_record)>0) {
                            ...
                            while ($r=mysqli_fetch_assoc($ass_record)) { $i++;
                                ...
                                <tr id="row<?php echo $i; ?>">
                                  <form  method="post" name="f<?php echo $i; ?>" id="f" action="edit_presentation_processing.php?sid=<?php echo $sid; ?>&id=<?php  echo $r['P_id']; ?>&loop=<?php echo $i; ?>" >
                                  <td> <input type="text" name="topic<?php echo $i; ?>" id="r1<?php echo $i; ?>" value="<?php  echo $r['p_topic'];  ?>"   readonly onchange="Fn_change(<?php echo $i; ?>)" style="border: none" required pattern="^[a-zA-Z][a-zA-Z0-9-_\s.]{2,50}$" title="Assignment Topic be start with Alphabit & between 3 to 50 character long"> </td>
                                  <td> <input type="date" name="datee<?php echo $i; ?>" id="r2<?php echo $i; ?>" value="<?php  echo $r['p_date'];  ?>"   readonly onchange="Fn_change(<?php echo $i; ?>)" style="border: none" required > </td>
                                  <td> <input type="number" name="obtained_marks<?php echo $i; ?>" id="r3<?php echo $i; ?>" value="<?php  echo $r['po_marks']; ?>" readonly onchange="Fn_change(<?php echo $i; ?>)" style="border: none" required min="0" max="<?php  echo $r['pt_marks']; ?>"> </td>
                                  <td> <input type="number" name="total<?php echo $i; ?>" id="r4<?php echo $i; ?>" value="<?php  echo $r['pt_marks']; ?>" readonly onchange="Fn_change(<?php echo $i; ?>)" style="border: none" min="1" max="5000"> </td>
                                  <style media="screen">
                                  ...
                                  <td id="dd<?php echo $i; ?>">
                                    ...
                                    <a href="delete_presentation_processing.php?i=<?php echo $i; ?>&id=<?php echo $r['P_id']; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>" id="conf_del<?php echo $i; ?>" style="display:none" > <button type="button" name="button" class="btn btn-sm btn-danger">conform</button> </a>
                                  </td>
                                </form>
                                </tr>
                                <?php
                            ...
                            <tr>
                              <td colspan="6" class="text-center alert alert-warning">No Presentation Yet. </td>
                            </tr>
                            <?php
                          }
                       ?>
