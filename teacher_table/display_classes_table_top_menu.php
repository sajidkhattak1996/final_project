...
<div class="container-fluid" id="table_maindiv" style="height: 39px;">
    <!-- below area and button such etc -->
    <div class="tabletabs" >
        <form  action="" method="post" >
              <ul>
                    <a href=""> <button id="b1" type="submit">  <b>      Class Record   </b> </button>  </a>
                    <a href="attendence_display.php"> <button id="b2" type="submit">  <b>      Attendence     </b>  </button> </a>
                    <a href=""> <button id="b3" type="submit">  <b>      Assignments    </b>  </button> </a>
                    <a href=""> <button id="b4" type="submit">  <b>      Quizes         </b>  </button> </a>
                    <a href=""> <button id="b5" type="submit">  <b>      Presentation   </b>  </button> </a>
                ...
                <style>
                      ...
                      <div class="dropdown">
                          ...
                          <div class="dropdown-content">
                            <a href="#"><button name="" style="background: none ; border: none"> Class Records </button></a>
                            <a href="#"><button name="" style="background: none ; border: none"> Attendence    </button></a>
                            <a href="#"><button name="" style="background: none ; border: none"> Assignment    </button></a>
                            <a href="#"><button name="" style="background: none ; border: none"> Quizes        </button></a>
                            <a href="#"><button name="" style="background: none ; border: none"> Presentation  </button></a>
