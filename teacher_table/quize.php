                    ...
                    <table class="table table-straped table-responsive-sm">
                          <thead>
                            <tr>
                                ...
                                <td>
                                      Date:<br>
                                      <input type="date" name="q_date" title="Enter the pregnment Date" value="<?php echo date('Y-m-d'); ?>" required style="background: lightblue;border: solid 1px #008c7e;border-radius:5px">
                                </td>
                                <form method="post">
                                  <td>
                                      Total Marks:<br> <input type="number" name="qt_marks" id="t_marks" value="" title="Enter pregnment Total Marks" min="1" max="5000" placeholder="marks" required style="background: lightblue;border: solid 1px #008c7e;border-radius:5px">
                                  </td>
                                </form>
                            </tr>
                          </thead>
                          <tr>
                            <td colspan="3">
                              <a href="edit_quize1.php" style="float:right"> <button type="button" name="edit_assignment" class="btn btn-outline-light"> Edit Quize </button> </a>
                            </td>
                          </tr>
                    </table>
                </div>
                                    ...
                                    while ($row=mysqli_fetch_assoc($exe)) { $a++;
                                      ...
                                      <tr  id="r<?php echo $a; ?>">
                                        ...
                                        <td>
                                          ...
                                          <input type="number" name="qo_marks<?php echo $a; ?>" id="ob_marks<?php echo $a; ?>" value="" title="please Enter the Student Obtained Marks" min="0" max="5000" required style="background: lightblue;border: solid 1px #008c7e;border-radius:5px">
                                        </td>
                                      </tr>
                                    <?php }
                                    $_SESSION['a']=$a;
