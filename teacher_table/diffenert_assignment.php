...
<!-- started -->
              ...
              <div class="container-fluid" style="padding-bottom: 10px">
                    ...
                    <table class="table table-straped">
                          <thead>
                            <tr>
                                ...
                                <td>
                                      Date:<br>
                                      <input type="date" name="a_date" value="<?php echo date('Y-m-d'); ?>" title="Enter the Assignment Date" required style="background: lightblue;border: solid 1px #008c7e;border-radius:5px">
                                </td>
                                <form method="post">
                                  <td>
               ...
               <div id="m2" class="alert alert-danger text-center" style="display:none"></div>
                 <div id="yes_table">
                   <table id="example1" class="table table-striped table-bordered table-hover table-sm table-light table-responsive-sm" >
                          <thead class="bg-info">
                              <tr>
                                    ...
                                    while ($row=mysqli_fetch_assoc($exe)) { $a++;
                                      ...
                                      <tr id="r<?php echo $a; ?>">
                                        ...
                                        <td>
                                          ...
                                          <input type="number" name="ao_marks<?php echo $a; ?>" id="ob_marks<?php echo $a; ?>" title="please Enter the Student Obtained Marks" min="0" max="5000" required style="background: lightblue;border: solid 1px #008c7e;border-radius:5px">
                                        </td>
                                      </tr>
                                    <?php }
                                    $_SESSION['a']=$a;
