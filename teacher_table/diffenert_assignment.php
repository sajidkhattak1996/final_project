                    ...
                    <table class="table table-straped">
                          <thead>
                            <tr>
                                ...
                                <td>
                                      Date:<br>
                                      <input type="date" name="a_date" title="Enter the pregnment Date" required style="background: lightblue;border: solid 1px #008c7e;border-radius:5px">
                                </td>
                                <form method="post">
                                  <td>
                                      Total Marks:<br> <input type="number" name="at_marks" value="" title="Enter pregnment Total Marks" min="1" max="5000" placeholder="marks" required style="background: lightblue;border: solid 1px #008c7e;border-radius:5px">
                                  </td>
                                </form>
                            </tr>
                          ...
                          <thead class="bg-info">
                            ...
                            <tbody>
                              ...
                              <tr>
                                    ...
                                    <td><input type="text" name="a_topic<?php echo $a; ?>"required  pattern="^[a-zA-Z][a-zA-Z0-9-_\s.]{1,80}$"  style="background: lightblue;border: solid 1px #008c7e;border-radius:5px; color: #000 "></td>
                                    <td>
                                      <input type="text" name="student_id<?php echo $a; ?>" value="<?php echo $row['S_id']; ?>" style="display:none">

                                      <input type="number" name="ao_marks<?php echo $a; ?>" value="" title="please Enter the Student Obtained Marks" min="0" max="5000" required style="background: lightblue;border: solid 1px #008c7e;border-radius:5px">
                                    </td>
                              </tr>
                               <?php }
                                $_SESSION['a']=$a;
                                        ...
                                        while ($t <= $a)
                                          {
                                            ...
                                            $a_topic=$_POST['a_topic'.$t];
                                            $obtained_marks=$_POST['ao_marks'.$t];
                                            date_default_timezone_set("Asia/Karachi");
                                            $ctime  =(int) (microtime(true) * 1000000000);   //current time in nano second

                                            $assi_insert="INSERT INTO assignment (a_name ,a_date,a_time ,at_marks) VALUES ('$a_topic', '$a_date','$ctime','$at_marks')";
                                            $exe_assi_insert=mysqli_query($con ,$assi_insert);

                                            $assi_id_stmt="SELECT A_id FROM assignment WHERE a_name='$a_topic' AND a_date='$a_date' AND a_time='$ctime' AND at_marks='$at_marks'";
                                          ...
                                          if ($temp==$t) {
                                            echo "<script> document.getElementById('spn').innerHTML='Assignment record are Successfully Inserted...'; setTimeout(myFn ,5000); </script>";
