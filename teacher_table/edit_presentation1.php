            ...
            <body>
              ...
              <!--============ended===============================================-->
                ...
                <div class="tend row py-3"  style="border-radius: 10px 10px 0px 0px;width:100%;margin:0 auto;margin-bottom: 8px;height: auto;padding-bottom:3px;padding-top: 0px">
                    ...
                    <div class="col-lg-2 col-sm-3">
                      <a href="edit_presentation_topic.php" class="btn btn-primary  float-right" > Edit Presentation Topic  </a>
                    </div>

                </div>

                <h5><strong>Note: </strong>Click on Student Name to Select them to Edit his/her Presentation.</h5>
                              ...
                              if (mysqli_num_rows($query2)>0) {
                                while ($row=mysqli_fetch_assoc($query2)) {
                                  ...
                                  <tr>
                                    ...
                                    <td><a href="edit_presentation2.php?id=<?php echo $row['S_id']; ?>" style="text-decoration:none"><?php echo $row['student_name']; ?></a></td>
                                  </tr>
                                  <?php
                                }
                              }else {
