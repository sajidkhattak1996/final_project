              ...
              <!--============ended=============================================================================================================================-->
                ...
                <table id="example1" class="table table-straped ">
                    ...
                    <tbody>
                      ...
                      <?php
                          $ass_record=mysqli_query($con ,"SELECT Presentation.P_id,Presentation.p_topic,Presentation.p_date,Presentation.pt_marks FROM Presentation INNER JOIN Presentation_record ON Presentation_record.P_id=Presentation.P_id WHERE Class_id='$cid' GROUP BY P_id ");
                          if (mysqli_num_rows($ass_record)>0) {
                            ...
                            while ($r=mysqli_fetch_assoc($ass_record)) { $i++;
                                ...
                                <tr id="row<?php echo $i; ?>">
                                  <form  method="post" name="f<?php echo $i; ?>" id="f" action="edit_Presentation_topic_processing.php?id=<?php  echo $r['P_id']; ?>&loop=<?php echo $i; ?>" >
                                  <td> <input type="text" name="topic<?php echo $i; ?>" id="r1<?php echo $i; ?>" value="<?php  echo $r['p_topic'];  ?>"   readonly onchange="Fn_change(<?php echo $i; ?>)" style="border: none" required pattern="^[a-zA-Z][a-zA-Z0-9-_\s.]{2,50}$" title="Presentation Topic be start with Alphabit & between 3 to 50 character long"> </td>
                                  ...
                                  <td> <input type="number" name="total_marks<?php echo $i; ?>" id="r4<?php echo $i; ?>" value="<?php  echo $r['pt_marks']; ?>" readonly onchange="Fn_change(<?php echo $i; ?>)" style="border: none" min="<?php  echo $r['pt_marks']; ?>" max="5000"> </td>
                                  <style media="screen">
                                  ...
                                  <td id="dd<?php echo $i; ?>">
                                    ...
                                    <a href="delete_Presentation_topic_processing.php?i=<?php echo $i; ?>&id=<?php echo $r['P_id']; ?>&cid=<?php echo $cid; ?>" id="conf_del<?php echo $i; ?>" style="display:none" > <button type="button" name="button" class="btn btn-sm btn-danger">conform</button> </a>
                                  </td>
                                </form>
                                </tr>
                                <?php
                            ...
                            <tr>
                              <td colspan="5" class="text-center alert alert-warning">No Presentation Yet. </td>
                            </tr>
                            <?php
                          }
                       ?>
