        ...
        <head>
              ...
              <script type="text/javascript">
                ...
                function myfn(obj_row_no){
                  ...
                  // if(c4==''){  alert('Please fill the field');  return false;}
                  if(c3>c4){  Status=1; }
                  if (status==1) {
            ...
            <body>
              ...
              <!--============ended=============================================================================================================================-->
                ...
                <table id="example1" class="table table-straped ">
                    ...
                    <tbody>
                      <?php
                          $ass_record=mysqli_query($con ,"SELECT assignment.A_id,assignment.a_name ,assignment.a_date,assignment.at_marks,assignment_record.ao_marks FROM assignment INNER JOIN assignment_record on assignment_record.A_id=assignment.A_id WHERE assignment_record.Class_id='$cid' AND assignment_record.S_id='$sid'");
                          if (mysqli_num_rows($ass_record)>0) {
                            ...
                            while ($r=mysqli_fetch_assoc($ass_record)) { $i++;
                                ...
                                <tr id="row<?php echo $i; ?>">
                                  ...
                                  <td> <input type="number" name="at<?php echo $i; ?>" id="r4<?php echo $i; ?>" value="<?php  echo $r['at_marks']; ?>" readonly onchange="Fn_change(<?php echo $i; ?>)" style="border: none" min="1" max="5000"> </td>
                                  <style media="screen">
                                  ...
                                  <td id="dd<?php echo $i; ?>">
                                    ...
                                    <a href="delete_assignment_processing.php?i=<?php echo $i; ?>&aid=<?php echo $r['A_id']; ?>&cid=<?php echo $cid; ?>&sid=<?php echo $sid; ?>" id="conf_del<?php echo $i; ?>" style="display:none" > <button type="button" name="button" class="btn btn-sm btn-danger">conform</button> </a>
                                  </td>
                                </form>
                                </tr>
                                <?php
                            ...
                            <tr>
                              <td colspan="6" class="text-center alert alert-warning">No Assignment Yet. </td>
                            </tr>
                            <?php
                          }
                       ?>
